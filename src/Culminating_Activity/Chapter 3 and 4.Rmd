...
```{r salary_distribution, fig.cap="Figure 4.1. Raw vs. Log-Transformed Salary Distribution"}
par(mfrow = c(1, 2))
...
```{r salary_by_role, fig.width=9, fig.height=6, fig.cap="Figure 4.2. Log Salary by Developer Role"}
...
```{r salary_by_employment, fig.cap="Figure 4.3. Log Salary by Employment Status"}
...
```{r salary_vs_experience, fig.cap="Figure 4.4. Log Salary vs. Years of Experience"}
