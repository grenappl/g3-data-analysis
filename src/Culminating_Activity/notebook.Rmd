...
# Model Validation (Checking if it is Overfitting or Underfitting)
...
test_r2 <- cor(preds, test_data$log_salary, use = "complete.obs")^2
cat("Test R²:", round(test_r2, 4), "\n")
cat("Train R²:", summary(model_train)$r.squared, "\n")
```

# Diagnostic Testing for da Model 
```{r}
par(mfrow = c(2, 2))
plot(model)
```
