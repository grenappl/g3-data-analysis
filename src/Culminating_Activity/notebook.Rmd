...
summary_df <- data.frame(
  Variable = c("Age", "Annual Salary", "Years Experience"),
  Summary = c(
    "Min=18, Median=31, Mean=31.3, Max=60",
    "Min=2000, Median=38000, Mean=58625, Max=368700",
    "Min=0, Median=8, Mean=9.39, Max=41"
  )
)
...
cor(num_cols, use = "complete.obs") %>%
  ...
  dplyr::arrange(desc(abs(log_salary)))
```
